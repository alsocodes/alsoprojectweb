...
const Service = () => {
  return (
    <section
      id='service'
      className={`py-10 md:py-20 bg-white text-base-content ${styles.mybg}`}
    >
      <div className='container px-5 md:px-0 mx-auto'>
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4'>
            <div className='mx-auto mb-[60px] max-w-[620px] text-center'>
              ...
              <h2 className='mb-4 text-xl font-bold text-dark sm:text-3xl'>
                Semua layanan kami...
              </h2>
              <p className='text-lg leading-relaxed text-base-content sm:text-xl sm:leading-relaxed'>
                {/* Sesuaikan kebutuhan mu dengan alsoproject, berikut layanan kami: */}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='-mx-4 flex flex-wrap justify-center'>
          <div className='w-full px-4 sm:w-full lg:w-1/3'>
            <div
              className='mb-10'
              data-aos-delay='300'
              data-aos-once='true'
            ...
            >
              ...
              <div className='text-center'>
                ...
                <p className='mb-5 text-base-content'>
                  Toko online berupa webiste maupun android app dengan fitur
                  lengkap, add to cart, checkout, shipping dan tracking, online
                  payment, dan membership.
                </p>
          ...
          <div className='w-full px-4 sm:w-full lg:w-1/3'>
            ...
            >
              <div className='h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full'>
                <img
                  src='/images/service-profile.jpg'
                  alt='image'
                  className='w-full rounded-full'
                />
                <span className='absolute top-0 left-0 z-[-1]'>
              ...
              <div className='text-center'>
                <h4 className='mb-2 text-lg font-medium text-dark'>
                  Webiste Profile/Informasi
                </h4>
                <p className='mb-5 text-base-content'>
                  Web menampilkan informasi perushaan, usaha, atau organisasi.
                  Sehingga orang lain dapat mudah mengakses dan meningkatkan
                  jangkauan exposure usaha Anda
                </p>
                {/* <div className="flex items-center justify-center">
                  <a
                    href="javascript:void(0)"
          ...
          <div className='w-full px-4 sm:w-full lg:w-1/3'>
            ...
            >
              ...
              <div className='text-center'>
                ...
                <p className='mb-5 text-base-content'>
                  Aplikasi web, desktop windows, atau mobile android dan ios
                  untuk kebutuhan perusahaan seperti absensi online, point of
                  sale, administrasi, akunting, dan lainnya.
                </p>
              </div>
            </div>
          </div>
