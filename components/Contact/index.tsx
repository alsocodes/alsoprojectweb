...
const Contact = () => {
  return (
    <section
      id='contact'
      className={`py-10 md:py-20 text-base-content overflow-hidden bg-[#f3f4fe]`}
    >
        ...
        <div className='-mx-4 flex flex-wrap items-center'>
          <div className='w-full px-4 lg:w-7/12 xl:w-8/12'>
            <div className='ud-contact-content-wrapper'>
              <div className='ud-contact-title mb-4'>
                <span className='mb-2 block text-lg font-semibold text-primary'>
                  Contact Us
                </span>
                <h2 className='mb-2 text-lg font-semibold text-dark sm:text-xl'>
                  Beri tahu kami jika Anda perlu informasi lebih lengkap, kami
                  siap membantu.
                </h2>
              </div>
                ...
                <div className='mb-8 flex w-[330px] max-w-full'>
                  ...
                  <div>
                    ...
                    <p className='text-base text-body-color'>
                      1st : Semolowaru Selatan I 80, Surabaya
                    </p>
                    <p className='text-base text-body-color'>
                      2nd : Woro 6/2 Kepohbaru, Bojonegoro
                    </p>
                  </div>
                </div>
                <div className='mb-8 flex w-[330px] max-w-full'>
                  ...
                  <div>
                    ...
                    <p className='text-base text-body-color'>0822 4530 7059</p>
                    <p className='text-base text-body-color'>
                      m.alishodikin@gmail.com
                    </p>
                  </div>
                </div>
              </div>
              ...
              <form>
                ...
                <div className='mb-6'>
                  ...
                  <input
                    type='email'
                    name='email'
                    placeholder='ahmadtatoew@gmail.com'
                    className='w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none'
                  />
                </div>
                <div className='mb-6'>
