...
const About = () => {
  return (
    <section
      id='about'
      className='py-10 md:py-20 bg-white text-base-content overflow-hidden'
    >
      <div className='container px-5 md:px-0 mx-auto'>
        ...
        >
          <div className='w-full px-4'>
            ...
            <div className='mb-12 lg:mb-20'>
              ...
              <h2 className='mb-4 text-xl font-bold text-dark sm:text-xl md:text-[30px]'>
                AlsoProject
              </h2>
              <p className='text-base-content'>
                hadir untuk menyediakan solusi platform digital berupa Website
                dan Mobile App untuk menunjang kesuksesan bisnis atau organisasi
                Anda. Kami menyediakan produk jasa pembuatan website atau mobile
                app segala jenis mulai dari toko online, company profile,
                sekolah/pendidikan, organisasi dan lainnya. Selain website, juga
                melayani pembuatan aplikasi berbasis web maupun android app
                seperti Sistem informasi Perpustakaan, sekolah, software
        ...
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
            <div
              className='group mb-12 bg-white'
              data-aos='fade-up'
              data-aos-once='true'
              data-aos-delay='200'
            >
              <div className='relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-success'>
              ...
              <h4 className='mb-3 text-lg font-semibold text-base-content'>
                Kualitas #1
              </h4>
              <p className='mb-8 text-base-content lg:mb-11 text-base'>
                Kami memberikan layanan terbaik bagi kepuasan Anda
              </p>
              {/* <a
          ...
          <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
            ...
            >
              ...
              <p className='mb-8 text-base-content lg:mb-11 text-base'>
                Kami memastikan selalu Up To Date dengan teknologi sesuai
                kebutuhan pasar.
              </p>
              {/* <a
                href="javascript:void(0)"
          ...
          <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
            ...
            >
              ...
              <p className='mb-8 text-base-content lg:mb-11 text-base'>
                Didukung <strong>the right man</strong> di bidangnya, memastikan
                hasil yang terbaik.
              </p>
              {/* <a
                href="javascript:void(0)"
          ...
          <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
            ...
            >
              ...
              <p className='mb-8 text-base-content lg:mb-11 text-base'>
                Kami memberi garansi support free kepada pelanggan selama masa
                kontrak
              </p>
              {/* <a
                href="javascript:void(0)"
